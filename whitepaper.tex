...
\usepackage{background} % Use for the DRAFT watermark
...
\backgroundsetup{
  ...
  contents={\tikz\node[opacity=0.3, scale=15]{DRAFT};}
} 
...
There is a proliferation in individual chains. Some projects strive to be cross chain, others launch their own special purpose chains. It's become difficult to keep up, and the value web3 off-chain compute projects have remains hidden and difficult to access. Web3 is both difficult and vast. 
...
We collaborate with a more centralized partner, Cubist, which specializes in providing TEE solutions. This partnership is part of our roadmap towards a fully decentralized offering. Initially, Cubist's TEE solutions will serve as a bootstrapping mechanism to enhance the security and reliability of our network. Over time, we aim to integrate more decentralized TEE solutions to align with our vision of a fully decentralized network. This strategic approach allows us to leverage advanced security technologies while working towards greater decentralization.
