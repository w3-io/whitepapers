...
\usepackage{newcent}      % Century Schoolbook for headings
\usepackage{courier}      % Monospaced for code/math
\usepackage{sectsty}      % Apply Century Schoolbook to section headings
\sectionfont{\fontfamily{pnc}\selectfont\bfseries}
\usepackage[T1]{fontenc}
\usepackage{setspace}
\setstretch{1.1}          % Slightly expanded line spacing

% ==============================================================================
% STYLE GUIDELINES - Model: Bitcoin whitepaper (Satoshi, 2008)
% ==============================================================================
% STRUCTURE:
%   - Abstract: Technical, 119 words exactly
